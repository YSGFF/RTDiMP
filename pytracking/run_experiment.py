...
def main():
    ...
    parser.add_argument('--experiment_module', default='myexperiments', type=str, help='Name of experiment module in the experiments/ folder.')
    parser.add_argument('--experiment_name', default='otb_test', type=str, help='Name of the experiment function.')
