...
class BiLevelRoutingAttention(nn.Module):
    ...
    """
    def __init__(self, dim, num_heads=6, n_win=7, qk_dim=None, qk_scale=None,mask_ratio=None,
    ...
    def forward(self, x, ret_attn_mask=False):
        ...
        # DropKey
        m_r = torch.ones_like(attn_weight) * self.mask_ratio
        attn_weight = attn_weight + torch.bernoulli(m_r) * -1e12
