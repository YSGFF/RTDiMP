...
@model_constructor
def rtdimpnet(filter_size=1, optim_iter=5, optim_init_step=1.0, optim_init_reg=0.01,
              classification_layer='layer3', feat_stride=16, backbone_pretrained=False, clf_feat_blocks=0,
    ...
    backbone_net = backbones.RTformer()
    # backbone_net = backbones.biformer_small(pretrained=backbone_pretrained)
    ...
    # DiMP network
    net = RTDiMPnet(feature_extractor=backbone_net, classifier=classifier, bb_regressor=bb_regressor,
