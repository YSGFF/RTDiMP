...
def main():
    ...
    parser.add_argument('--train_module', type=str, default='RTDiMP', help='Name of module in the "train_settings/" folder.')
    parser.add_argument('--train_name', type=str, default='RTDiMP', help='Name of the train settings file.')
